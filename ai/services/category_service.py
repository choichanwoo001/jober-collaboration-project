...
class CategoryService:
    ...
    def create_category_if_not_exists(self, category_name: str, description: str = None) -> Optional[Category]:
        """카테고리가 존재하지 않으면 생성"""
        try:
            ...
            if not AUTO_CREATE_CATEGORIES:
                ...
                return self.get_category_by_name("기타")
    ...
    def update_category_usage_count(self, category_id: int):
        """카테고리 사용 횟수 업데이트"""
        try:
