...
#     """카테고리 판단 프롬프트"""
#     def __init__(self, userMessage: str, category_main: str, category_sub_list: list):
#         super().__init__(userMessage)
#         self.hints: list[dict] = []
...
# 원본 사용자 텍스트: {self.request.userMessage}
#
...
# 의도 유형: {self.request.intent_type}
# 수신자 범위: {self.request.recipient_scope}
# 원본 메시지: {self.request.userMessage}
#
